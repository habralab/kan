    ...
    expect(
      getTrelloBoardBackground({
        ...
        backgroundImageScaled: [
          { width: 480, height: 320, url: "https://example.com/480.jpg" },
          { width: 1920, height: 1080, url: "https://example.com/1920.jpg" },
          { width: 960, height: 640, url: "https://example.com/960.jpg" },
        ],
      }),
    ).toEqual({
      kind: "image",
